# Mask: Generates a binary representation of an image based on the alpha property.
...
**Autor : [JS-Boss] (http://JS-Boss.github.io)**
...
**Practical Example**
Convert an image with some transparent area yourself, click *[here](http://)*. Zoom in on the generated text to clearly see the 1s form the chosen image.
...
You can send me an *[email](http://)*, or use any of the below platforms where i have writen about this project.
![Twiter](http://) ![LinkedIn](http://) ![Blogspot](http://) ![Medium](http://) ![Tumblr](http://) 
...
[AirTM](https://) [paypal.me/JS-Boss](https://) [Email me](http://)
